...
function build(){
	...
	#cat $PACKAGE
	{
        ...
        #module light
		{
			...
			MODULE_LIGHT_CWTYPE=$(fjq .modules.light.cwtype)
	   		...
	   		MODULE_LIGHT_REMDMODE=$(fjq .modules.light.remdmode)
			...
			MODULE_LIGHT_PRODAGAIN=$(fjq .modules.light.prodagain)
			MODULE_LIGHT_CAGT=$(fjq .modules.light.cagt)
			MODULE_LIGHT_WT=$(fjq .modules.light.wt)
			MODULE_LIGHT_RGBT=$(fjq .modules.light.rgbt)
			MODULE_LIGHT_COLORPFUN=$(fjq .modules.light.colorpfun)
			MODULE_LIGHT_COLORMAXP=$(fjq .modules.light.colormaxp)
	...
	echo "> [build-step2]-------------------------------------------"
	{
		...
		if [ "$MODULE_LIGHT" != "null" ];then
            ...
            f_write 'echo "#define DEFAULT_CONFIG \"{Jsonver:'$MODULE_LIGHT_JSONVER',category:'$MODULE_LIGHT_CATEGORY',module:'$MODULE_LIGHT_MODULE',cmod:'$MODULE_LIGHT_CMOD',dmod:'$MODULE_LIGHT_DMOD',cwtype:'$MODULE_LIGHT_CWTYPE',\
onoffmode:'$MODULE_LIGHT_ONOFFMODE',pmemory:'$MODULE_LIGHT_PMEMORY',defcolor:'$MODULE_LIGHT_DEFCOLOR',defbright:'$MODULE_LIGHT_DEFBRIGHT',deftemp:'$MODULE_LIGHT_DEFTEMP',\
cwmaxp:'$MODULE_LIGHT_CWMAXP',brightmin:'$MODULE_LIGHT_BRIGHTMIN',brightmax:'$MODULE_LIGHT_BRINGTMAX',colormin:'$MODULE_LIGHT_COLORMIN',colormax:'$MODULE_LIGHT_COLORMAX',\
wfcfg:'$MODULE_LIGHT_WFCFG',rstmode:'$MODULE_LIGHT_RSTMODE',rstnum:'$MODULE_LIGHT_RSTNUM',remdmode:'$MODULE_LIGHT_REMDMODE',rstcor:'$MODULE_LIGHT_RSTCOR',rstbr:'$MODULE_LIGHT_RSTBR',\
rsttemp:'$MODULE_LIGHT_RSTTEMP',pwmhz:'$MODULE_LIGHT_PWMHZ',pairt:'$MODULE_LIGHT_PAIRT',notdisturb:'$MODULE_LIGHT_NOTDISTURB',prodagain:'$MODULE_LIGHT_PRODAGAIN',cagt:'$MODULE_LIGHT_CAGT',\
wt:'$MODULE_LIGHT_WT',rgbt:'$MODULE_LIGHT_RGBT',colorpfun:'$MODULE_LIGHT_COLORPFUN',colormaxp:'$MODULE_LIGHT_COLORMAXP',r_pin:'$MODULE_LIGHT_R_PIN',r_lv:'$MODULE_LIGHT_R_LV',g_pin:'$MODULE_LIGHT_G_PIN',\
g_lv:'$MODULE_LIGHT_G_LV',b_pin:'$MODULE_LIGHT_B_PIN',b_lv:'$MODULE_LIGHT_B_LV',c_pin:'$MODULE_LIGHT_C_PIN',c_lv:'$MODULE_LIGHT_C_LV',w_pin:'$MODULE_LIGHT_W_PIN',w_lv:'$MODULE_LIGHT_W_LV',\
iicr:'$MODULE_LIGHT_IIC_R',iicg:'$MODULE_LIGHT_IIC_G',iicb:'$MODULE_LIGHT_IIC_B',iicc:'$MODULE_LIGHT_IIC_C',iicw:'$MODULE_LIGHT_IIC_W',iicscl:'$MODULE_LIGHT_IIC_SCL',iicsda:'$MODULE_LIGHT_IIC_SDA',\
ctrl_pin:'$MODULE_LIGHT_CTRL_PIN',ctrl_lv:'$MODULE_LIGHT_CTRL_LV',campere:'$MODULE_LIGHT_IIC_CAMPERE',wampere:'$MODULE_LIGHT_IIC_WAMPERE',wr:'$MODULE_LIGHTL_WR',wg:'$MODULE_LIGHTL_WG',wb:'$MODULE_LIGHTL_WB',\
gr:'$MODULE_LIGHTL_GR',gg:'$MODULE_LIGHTL_GG',gb:'$MODULE_LIGHTL_GB',crc:'$MODULE_LIGHTL_CRC',}\" ">> $CONFIG_FILE'    
		...
		f_write 'grep -n "DEFAULT_CONFIG" $CONFIG_FILE | cut -f1 -d: | xargs -I {} sed -i "{}s:,*\:null,:,:g" $CONFIG_FILE'	
...
#git_id: 4729fe0984b251e0e803109738f14d5fe4fa6d04
#date: 2020年 12月 18日 星期五 11:33:42 CST
