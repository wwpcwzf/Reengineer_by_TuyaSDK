...
{
    //ty_light_driver_set_rgbcw(tLightCtrlHandle.tCurrVal.usRed, tLightCtrlHandle.tCurrVal.usGreen, tLightCtrlHandle.tCurrVal.usBlue, tLightCtrlHandle.tCurrVal.usWhite, tLightCtrlHandle.tCurrVal.usWarm);
}
