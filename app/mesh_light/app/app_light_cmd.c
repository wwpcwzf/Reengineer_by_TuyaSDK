        ...
        case TYPE_FAV_FUR_DATA:{ 
                ...
                if(FALSE == tReadFavData.bPower)
                {
                    ...
                    case SCENE_MODE:{
                        ...
                        ty_light_scene_cmd_data_set(scene_num,1);
                        }
                        break;
                    default:
                        break;
...
#if (LIGHT_CFG_3IN1_SAVE == 1)
    opRet = ty_light_save_user_flash_read_3in1_data(TYPE_APP_DATA,&tAPPData);       /* read app flash data! */	
    opRet2 = ty_light_save_user_flash_read_3in1_data(TYPE_MEM_DATA,&tMemData);
#else
