...
#define	IV_IDX_CUR		{0x00,0x00,0x00,0x00}
#define DEVKEY_DEF 		{0x9d,0x6d,0xd0,0xe9,0x6e,0xb2,0x5d,0xc1, 0x9a,0x40,0xed,0x99,0x14,0xf8,0xf0,0x3f}
#define NETKEY_A 		{0x07,0xD0,0x14,0x33,0xA9,0x54,0xA4,0x60, 0xAD,0x16,0x89,0xE6,0x59,0x4F,0x07,0xDA}
#define APPKEY_A		{0xD0,0x07,0x10,0xA0,0xA6,0x01,0x37,0x08, 0x54,0xE3,0x2E,0x17,0x7A,0xFD,0x11,0x59}
...
typedef struct{
    model_g_light_s_t srv[1];			// server
...
typedef struct{
#if MD_SERVER_EN
	u8 on_powerup[ELE_CNT];               // can't delete
	trans_time_t trans_time[ELE_CNT];     // can't delete
#endif
...
typedef struct{
#if MD_SERVER_EN
	model_g_light_s_t srv[ELE_CNT];			// server
	model_g_light_s_t setup[ELE_CNT];			// server
#endif
...
void mesh_composition_data_set(mesh_page0_head_t *head);
...
extern model_vd_tuya_t       	model_vd_tuya;
#if (LIGHT_LIGHTNESS_SERVER_EN || LIGHT_LIGHTNESS_CLIENT_EN)
extern model_lightness_t       model_sig_lightness;
#endif
#if (LIGHT_CTL_SERVER_EN || LIGHT_CTL_CLIENT_EN)
extern model_light_ctl_t       model_sig_light_ctl;
#endif
#if (LIGHT_HSL_SERVER_EN || LIGHT_HSL_CLIENT_EN)
extern model_light_hsl_t       model_sig_light_hsl;
#endif
#if (GENERIC_ONOFF_SERVER_EN || GENERIC_ONOFF_CLIENT_EN)
extern model_g_onoff_level_t	model_sig_g_onoff_level;
#endif
