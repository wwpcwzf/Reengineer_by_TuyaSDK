...
#define TY_SCENE_SAVE       0x79000
#define TY_SCENE_ID_SAVE    0x79E00
...
#define FLASH_3IN1_DATA_SIZE_MAX  (sizeof(LIGHT_MEM_USER_FLASH_T) + sizeof(LIGHT_APP_DATA_FLASH_T) + sizeof(LIGHT_MDEV_TEST_DATA_FLASH_T) + (sizeof(LIGHT_FAVORITE_DATA_FLASH_T))*4 +9)
